    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pincode', models.CharField(db_index=True, max_length=15)),
                ('country_code', models.CharField(db_index=True, max_length=5)),
                ('mobile_number', models.CharField(db_index=True, max_length=15)),
                ('entity', models.CharField(choices=[('Enterprise', 'Enterprise'), ('Individual', 'Individual'), ('Government', 'Government')], db_index=True, default='Individual', max_length=50)),
                ('fax', models.CharField(blank=True, db_index=True, max_length=20, null=True)),
