...
SECRET_KEY = 'django-insecure-nceo*n*abj9esh!tcem_yw_%wufxp36yckw8@u7oa6^14_vlge'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=12),  # Access token will expire in 12 hours
